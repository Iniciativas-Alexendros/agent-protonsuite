...
[![Coverage](https://img.shields.io/badge/coverage-92.68%25-yellowgreen?logo=vitest&logoColor=white)](https://github.com/Iniciativas-Alexendros/agent-protonsuite/actions/workflows/quality.yml)
...
npm test            # 692 tests (Vitest)
npm run coverage    # Coverage (v8 — 92.68% statements)
...
**Próximos módulos objetivo:** bridge-client.ts (80%), config.ts (79.23%), http.ts (81.65%), config/drive.ts (82.14%), server/drive.ts (89.14%).
